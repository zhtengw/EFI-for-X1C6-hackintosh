SSDT-ALS0.aml		Fake Ambient light Sensor to save LCD brightness
SSDT-Battery.aml	Battery(need battery renamed )
SSDT-Keyboard-X!C6.aml	Thinkpad Clickpad and keyboard hotkeys(See detail in #1 keyboard hotkey)
...
#1 keyboard hotkey:
Make toggle Fn+4 act as LID open/close, need SLPWAK for this function;
...
I defined shortcut to make Fn+F9(F19) open "System Preferences.app", Fn+PrtSc(F16) to open  Screenshot.app
